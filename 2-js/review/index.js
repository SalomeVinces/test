...
// // Word variable
// let word = "floWers";
// let firstLetter = "f".toUpperCase();  //=word[0]
//     // console.log(firstLetter)
// let restOfWord = "loWers".toLowerCase(); //=word.slice(1)
//     // console.log(restOfWord)
// let fullWord = firstLetter + restOfWord; //=fistletter.toUpperCase() + restOfWord()
// // console.log(fullword)

// console.log(word[0]);
// console.log(word.slice(1));
// console.log(firstLetter.toUpperCase("floWers"));
// console.log(restOfWord.toLowerCase("floWers"));

// console.log(fullWord)

// // let fullWord = word[0].toUpperCase() + word.slice(1).toLowerCase;  //Method chaining to reduce lines of code.
...
//     if (name.toLowerCase()===enemy.toLowerCase()){
